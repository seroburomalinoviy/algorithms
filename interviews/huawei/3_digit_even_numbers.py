...
"""
Поиск четных трехзначных чисел
...
Целое число состоит из трех элементов, состоящих из цифр в произвольном порядке.
...
Пример 1:
Ввод: цифры = [2,1,3,0]
Выходные данные: [102,120,130,132,210,230,302,310,312,320]
Пояснение: Все возможные целые числа, соответствующие требованиям, содержатся в выходном массиве.
Обратите внимание, что здесь нет нечетных чисел или целых чисел с начальными нулями.
...
В этом примере цифра 8 используется дважды каждый раз в числах 288, 828 и 882.

Пример 3:
Входные данные: цифры = [3,7,5]
Выходные данные: []
Пояснение: Из данных цифр нельзя составить четные целые числа.
